...
class _CalendarioScreenState extends State<CalendarioScreen> {
  ...
  Future<int> _consultarPlazasApi(String fecha, int horarioId) async {
    try {
      ...
      final url = 'http://192.168.7.13:8082/citas/disponible?fecha=$fecha&horarioId=$horarioId';
  ...
  Future<void> _confirmarReserva(HorarioSemanal h) async {
    ...
    if (clienteId == null) {
      _mostrarSnackBar("Error: No se encontró el ID del usuario", Colors.redAccent);
      return;
    }
      ...
      body: Column(
        ...
        children: [
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: negroSuave, letterSpacing: 1.2),
                  ),
                ),
                TableCalendar(
                  locale: 'es_ES',
          ...
          const Padding(
            ...
            child: Text("HORARIOS DISPONIBLES", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.grey, letterSpacing: 1.1)),
          ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text("No hay turnos disponibles", style: TextStyle(color: Colors.grey)),
          ],
        ),
      );
    }
                  ...
                  Row(
                    children: [
                      Icon(
                        ...
                        size: 14, 
                        color: disponible ? (libres == 1 ? Colors.orange : Colors.green) : Colors.red
                      ),
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 13, 
                          color: disponible ? (libres == 1 ? Colors.orange[800] : Colors.green[700]) : Colors.red[700],
