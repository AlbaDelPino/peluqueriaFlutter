...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _onCreateAccountPressed() {
    // UI-only: al crear cuenta volvemos al Login y limpiamos la pila
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Registro'), backgroundColor: primary, elevation: 0, automaticallyImplyLeading: false),
      body: Center(
            ...
            child: Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  TextButton(onPressed: () => Navigator.pop(context), child: const Text('Inicia sesión', style: TextStyle(color: primary))),
                ]),
              ]),
            ),
          ),
